  ...
  return (
    ...
    >
      <ul className="list-disc list-inside space-y-1">
        <li>
          <span className="font-bold">연차수당 계산기</span>로{" "}
          <span className="font-bold">미사용 연차수당</span>을 간편하게 확인해보세요.
        </li>
        <li>
          <span className="font-bold">연차수당</span>은{" "}
          <span className="font-bold">미사용 연차일수 × 1일 통상임금</span>으로 계산됩니다.
        </li>
        <li>
          <span className="font-bold">1일 통상임금</span>은{" "}
          <span className="font-bold">월급 ÷ 월 소정근로시간 × 1일 근로시간</span>으로 산정합니다.
        </li>
        <li>
          통상임금은{" "}
          <Link
        ...
        <li>
          ...
          <ul className="list-disc list-inside ml-5">
            <li>
              시급: <b>시급 × 1일 근무시간</b>
              <br />
              예시: 시급 10,320원, 1일 8시간 → 10,320 × 8 = 82,560원
            </li>
            <li>
              일급: <b>입력한 일급 그대로 사용</b>
              <br />
              예시: 일급 82,560원 입력 시 → 82,560원
            </li>
            <li>
              월급: <b>월급 ÷ (주평균근무일수 × 4.345)</b> (주5일제 기준 21.725)
              <br />
              예시: 월급 2,152,700원, 주5일 → 2,152,700 ÷ 21.725 ≈ 99,126원
            </li>
          </ul>
        </li>
        <li>
    ...
    >
      ...
      <div className="space-y-6">
        <div>
          ...
          <div>
            연차수당은 <b>연차휴가 발생 후 1년 이내에 사용하지 않은 연차</b>에 대해 <b>다음 연도 초에 일괄 지급</b>하는 것이 원칙입니다.
            퇴직 시 미사용 연차가 남아 있다면 퇴직일 기준으로 정산하여 지급합니다.
            지급기준은 근로기준법에 따라 회사마다 다를 수 있지만, 법정 기준을 반드시 따라야 합니다.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 연차수당 계산 시 통상임금은 어떻게 산정하나요?</div>
          <div>
            <b>통상임금</b>은 <b>월급(기본급 + 고정수당 등) ÷ 1개월 소정근로시간 × 1일 근로시간</b>으로 계산합니다.
            미사용 연차수당은 <b>연차 미사용일수 × 1일 통상임금</b>으로 산정합니다.
            통상임금은 연차를 청구할 수 있는 마지막 달의 임금을 기준으로 산정하는 것이 원칙입니다.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 신입사원이나 1년 미만 근로자도 연차수당을 받을 수 있나요?</div>
          <div>
            받을 수 있습니다. <b>1년 미만 근로자도 1개월 개근 시 1일의 연차가 발생</b>하며, 사용하지 않은 경우 연차수당을 받을 수 있습니다.
            다만, 출근율 80% 미만 등 일부 조건에서는 발생하지 않을 수 있습니다.
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div>
            일부 회사는 취업규칙이나 단체협약에 따라 지급 시기나 방식이 다를 수 있지만,
            <b>최소한 법정 기준(근로기준법)</b>은 반드시 준수해야 합니다.
            회사 규정이 법정 기준보다 불리하면 법정 기준이 우선 적용됩니다.
          </div>
        </div>
        <div>
...
export default function AnnualLeaveCalculator() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10 px-2 sm:px-4 lg:px-8 w-full">
      <h1 className="text-3xl font-bold text-gray-900 text-center mb-8">연차수당 계산기</h1>
      ...
      <div className="max-w-[1200px] mx-auto bg-white rounded-lg shadow-md p-4 sm:p-10 flex flex-col lg:flex-row gap-8 w-full">
        ...
        <section className="w-full lg:w-1/2 border-r border-gray-200 pr-0 lg:pr-8 min-w-0">
          ...
          {inputUnit === "hourly" && (
            <InputRow label="1일 근무시간" tooltip={`하루 기준 근무시간을 입력하세요.\n예: 8`}>
              <input
                type="text"
                inputMode="decimal"
                pattern="^\\d*(\\.\\d{0,2})?$"
          ...
          <InputRow label="미사용 연차일수" tooltip={`지급받을 연차(유급휴가) 미사용 일수를 입력하세요.`}>
            <input
              type="text"
              inputMode="decimal"
              pattern="^\\d*(\\.\\d{0,2})?$"
