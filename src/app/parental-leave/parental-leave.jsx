    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div>
            육아휴직 급여는 육아휴직 개시 후 고용센터 방문 또는 고용24 등 온라인 시스템을 통해 <b>신청</b>할 수 있습니다. 신청 시에는 육아휴직 확인서, 통상임금 확인자료 등 관련 서류가 필요하며, 회사 인사팀의 협조가 요구될 수 있습니다.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 육아휴직 급여는 언제, 어떤 방식으로 지급되나요? (지급일)</div>
          <div>
            2025년부터는 <b>사후지급제도</b>가 폐지되어, 육아휴직 기간 중 매월 전액이 지급됩니다. 신청 후 심사를 거쳐 통상적으로 14일 이내에 지급되며, 지급일은 고용센터 처리 일정과 공휴일에 따라 달라질 수 있습니다.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 육아휴직 급여는 최대 몇 개월까지 받을 수 있나요?</div>
          <div>
            육아휴직 급여는 자녀 1인당 최대 <b>18개월(1년 6개월)</b>까지 신청할 수 있습니다. 부모가 순차적으로 사용할 경우 각자 18개월씩, 동시 사용 시에도 합산하여 18개월까지 가능합니다. 급여 산정 금액은 개월수에 따라 상이합니다.
          </div>
        </div>
        <div>
