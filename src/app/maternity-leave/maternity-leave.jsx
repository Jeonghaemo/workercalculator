    ...
    >
      ...
      <ol className="list-decimal list-inside mb-4 space-y-1">
        <li>
          <b>월별 지급액 산정:</b>
          <span className="ml-1">
            <b>통상임금(월)</b>과 <b>월 상한액(2,200,000원)</b> 중 작은 금액을 월별 지급액으로 산정<br />
            예시: 통상임금(월) 2,300,000원 → 월별 지급액 2,200,000원(상한 적용)<br />
        ...
        <li>
          <b>상한액 적용:</b>
          <span className="ml-1">
            통상임금(월)이 2,200,000원을 초과할 경우 월별 지급액은 2,200,000원으로 제한<br />
예시: 통상임금(월) 2,500,000원 → 월별 지급액 2,200,000원
      ...
      <div className="text-sm text-gray-600">
        ...
        ※ 상한액(월 2,200,000원)은 2026년 1월 기준이며, 매년 변동될 수 있습니다.
    ...
    >
      ...
      <div className="space-y-6">
        <div>
          ...
          <div>
            <b>출산휴가급여</b>는 근로자의 <b>통상임금</b>을 기준으로 산정됩니다. 통상임금에는 기본급과 매달 고정적으로 지급되는 수당이 포함되지만, 식대·교통비·상여금 등은 제외될 수 있습니다. 2026년 기준, 월 최대 상한액과 최저임금 하한액이 적용됩니다.
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div>
            2026년 기준, 출산휴가급여는 월 통상임금 기준 <b>상한액</b>과 <b>하한액(최저임금)</b>이 적용됩니다. 상한액은 매년 고용노동부에서 고시하며, 하한액은 출산휴가 시작일 기준 최저시급을 반영합니다. 실제 지급 금액은 회사와 정부지원금 합산액에서 결정됩니다.
          </div>
        </div>
      </div>
    </div>
...
// 계산 함수
function calcMaternityPay({ wage, days = 90, maxMonthly = 2200000 }) {
