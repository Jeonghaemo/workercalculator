...
export const metadata = {
  title: {
    default: "근로·급여 계산기",
    template: "%s | 근로·급여 계산기",
  },
  description:
    "연봉, 시급, 주휴수당, 퇴직금, 4대 보험, 출산휴가·육아휴직, 연장·야간·휴일수당, 실업급여, 성과급, 통상임금, 최저시급, 소득세 등 각종 급여와 세금 계산기를 한 곳에서 쉽게 이용하세요.",
  keywords:
    "연봉 계산기, 시급 계산기, 월급 계산, 주휴수당, 퇴직금, 실수령액, 4대 보험, 출산휴가, 육아휴직, 연차수당, 통상임금, 최저시급, 실업급여, 성과급, 소득세, 퇴직소득세, 2025 세금, 근로소득",
  openGraph: {
    title: "근로·급여 계산기",
    description:
      "연봉, 시급, 주휴수당, 퇴직금, 4대 보험, 출산휴가·육아휴직, 연장·야간·휴일수당, 실업급여, 성과급, 통상임금, 최저시급, 소득세 등 각종 급여와 세금 계산기를 한 곳에서 쉽게 이용하세요.",
