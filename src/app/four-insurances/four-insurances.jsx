    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div>
            포함됩니다.<b>주휴수당</b>은 근로계약서상 정기적·일률적으로 지급되는 임금이므로, 월급에 포함되어 4대 보험료 산정 기준이 됩니다. 주휴수당을 별도로 받는 일용직이나 단시간 근로자도 해당 금액이 월 소득에 포함됩니다<span className="text-gray-500 text-xs"></span>.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 일용직 근로자도 4대 보험에 가입되나요?</div>
          <div>
            일용직도 일정 조건(월 8일 이상 또는 60시간 이상 근무 등)을 충족하면 국민연금, 건강보험, 고용보험 가입 대상이 됩니다. 단, 근무일수나 시간, 고용형태에 따라 일부 보험은 제외될 수 있으니, 본인의 근로조건을 반드시 확인해야 합니다<span className="text-gray-500 text-xs"></span>.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 4대 보험료는 월급 외에 어떤 소득이 포함되나요?</div>
          <div>
            4대 보험 산정 기준에는 <b>월급(기본급, 고정수당, 주휴수당 등)</b>이 모두 포함됩니다. 비과세 수당이나 일시적·비정기적 수당은 제외될 수 있습니다. 실제 보험료 산정 시 회사의 급여명세서를 참고하세요<span className="text-gray-500 text-xs"></span>.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 4대 보험료와 소득세는 어떻게 다르며, 둘 다 공제되나요?</div>
          <div>
            4대 보험료(국민연금, 건강보험, 장기요양, 고용보험)는 월급에서 자동 공제되며, <b>소득세</b> 역시 별도로 원천징수됩니다. 즉, 월급에서 4대 보험료와 소득세 모두 차감된 금액이 실제 실수령액입니다<span className="text-gray-500 text-xs"></span>.
          </div>
        </div>
        <div>
          <div className="font-bold mb-1">Q 2025년 4대 보험 요율과 상한·하한 기준은 어떻게 되나요?</div>
          <div>
            2025년 기준 국민연금은 4.5%, 건강보험 3.545%, 장기요양보험 0.4591%, 고용보험 0.9%입니다. 국민연금은 기준소득월액이 39만원~617만원(2024.7~2025.6 적용), 건강보험도 월 소득에 따라 상한·하한이 있습니다. 산재보험은 업종별로 다르니 확인이 필요합니다<span className="text-gray-500 text-xs"></span>.
          </div>
        </div>
      </div>
    </div>
